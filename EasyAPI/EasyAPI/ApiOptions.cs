...
namespace EasyAPICore
{
    public class ApiOptions
    {
        public ApiOptions()
        {
            ...
            AssemblyApiOptions = new Dictionary<Assembly, AssemblyApiOptions>();
        }
        ...
        /// </summary>
        public Dictionary<Assembly, AssemblyApiOptions> AssemblyApiOptions { get; }
        public IRouteBuilder RouteBuilder { get; set; } = new RouteBuilder();
        ...
        public void AddAssemblyOptions(Assembly assembly, string apiPreFix = null, string httpVerb = null)
        {
            ...
            this.AssemblyApiOptions[assembly] = new AssemblyApiOptions(apiPreFix, httpVerb);
        }
    }
}
